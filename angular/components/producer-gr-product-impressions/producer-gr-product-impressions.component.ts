...
@Component({
  selector: 'app-producer-gr-product-impressions',
  templateUrl: './producer-gr-product-impressions.component.html',
  styleUrls: ['./producer-gr-product-impressions.component.css']
})
export class ProducerGrProductImpressionsComponent implements OnInit, OnChanges {
  ...
  private _loadData() {
    this.loading = true;
    if(this.date != ''){
      this._producerGraphicService.getProductImpressions(this.weedId, this.provinceId, this.date)
