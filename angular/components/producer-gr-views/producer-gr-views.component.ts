...
@Component({
  selector: 'app-producer-gr-views',
  templateUrl: './producer-gr-views.component.html',
  styleUrls: ['./producer-gr-views.component.css']
})
export class ProducerGrViewsComponent implements OnInit, OnChanges {
  ...
  private _loadData() {
    this.loading = true;
    if(this.time != ''){
      this._producerGraphicService.getProducerViews(this.userId, this.provinceId, this.time)
