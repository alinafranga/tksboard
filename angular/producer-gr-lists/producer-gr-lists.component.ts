...
@Component({
  selector: 'app-producer-gr-lists',
  templateUrl: './producer-gr-lists.component.html',
  styleUrls: ['./producer-gr-lists.component.css']
})
export class ProducerGrListsComponent implements OnInit, OnChanges {
  ...
  private _loadData() {
    this.loading = true;
    if(this.time != ''){
      this._producerGraphicService.getProducerLists(this.userId, this.provinceId, this.time)
